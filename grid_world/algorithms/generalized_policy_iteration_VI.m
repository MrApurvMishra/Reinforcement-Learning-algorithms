...
function [V, policy_index] = generalized_policy_iteration_VI(world, precision_pi, precision_pe, max_ite_pi, max_ite_pe)
    %% Initialization
    % MDP
    mdp = world.mdp;
    T = mdp.T;
    ...
    while iter < max_ite_pi
        %% VALUE ITERATION - [TODO] policy Evaluation (PE)
